...
11. **Run Lighthouse on the live site** once the deploy is live: confirm the new version is served
...
12. Tell the owner what you checked, both sets of Lighthouse scores, and anything you couldn't verify.
